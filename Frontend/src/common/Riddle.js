...
function Riddle() {
    ...
    return (
        <div style={{marginLeft:"-100px"}}>
            <h1 style={{marginTop:"15px"}}>Welcome to the Einstien's Five house Riddle</h1>
            ...
            <br />
            <ol>
<p><li>1.The Englishman lives in the red house.</li>
...
<li>15.The Blend smoker has a neighbor who drinks water. </li></p>
